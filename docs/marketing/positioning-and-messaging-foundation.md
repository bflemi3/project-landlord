...
- **Flat monthly pricing, never a percentage of rent.** Mabenn never takes a cut. **R$ 49/month per active rental, or R$ 490/year (two months free). First active rental is always free. Tenants are free forever, with or without their landlord on the product. Single tier — same product whether you have 1 rental or 30.**
- **Founding members.** Landlords and imobiliárias who sign up through the waitlist get their **first year free on every active rental, then R$ 39/month locked for life**. A visible `Founding member` badge appears on their profile and reputation card — it doesn't expire when the locked rate kicks in. The badge is a permanent status signal: this user was here before launch.
...
**Q: What does it cost?**
A: R$ 49/month per active rental, or R$ 490/year (two months free). First rental free. Tenants free forever. Founding members (waitlist signups) get a full year free and a locked R$ 39/month rate after.
...
| 4 | Pricing is **flat monthly per active rental, never a percentage.** Base plan: R$ 49/month per active rental (or R$ 490/year, two months free), first active rental free, tenants free forever. Founding members (waitlist signups) get their first year free on every active rental, then R$ 39/month locked for life, plus a visible `Founding member` badge on their profile. Single tier — no Pro plan for now; imobiliária-specific pricing not separated. | Confirmed in-session 2026-05-24: full pricing structure locked. | Low — committed; only the R$ 49 number could move (within R$ 39–59 range) if market response demands. The "never a %" and "founding member badge" commitments are positioning anchors. |
...
1. ~~**Exact pricing numbers.**~~ **Resolved (in-session 2026-05-24):** R$ 49/month per active rental, R$ 490/year (two months free), first rental free, tenants free forever. Founding members get first year free, then R$ 39/month locked for life, plus a visible `Founding member` badge. Single tier. No separate imobiliária pricing. See Section 7 (Features) and Assumption #4 for full structure.
