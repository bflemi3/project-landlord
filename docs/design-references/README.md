...
| `communication.html` | Communication inbox | two-pane inbox (message list + open message), type chips, magenta response-time pill, quoted reply block, photo + source-doc chips |
