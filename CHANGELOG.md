...
- Create a new account with your name, email, password, and optional profile photo
- Reset your password via email if you forget it
- Email verification for new accounts — the page updates automatically once you confirm
