...
export async function inviteTenant(
  ...
  try {
    await resend.emails.send({
      ...
      subject: `You're invited to join ${propertyName} on mabenn`,
      html: buildTenantInviteEmail({ tenantName, landlordName, propertyName }),
    })
  } catch {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:40px auto;padding:0 24px">
    <tr><td>
      ...
      <div style="background:#fff;border:1px solid #e4e4e7;border-radius:16px;padding:32px">
        ...
        <p style="font-size:16px;color:#52525b;margin:0 0 24px">${greeting} ${landlordName} has invited you to join <strong>${propertyName}</strong> on mabenn. You'll be able to view your monthly statements, see charge details, and track payments.</p>
        <a href="https://mabenn.com/auth/sign-up" style="display:block;background:#14b8a6;color:#fff;font-weight:700;font-size:16px;text-align:center;padding:12px 24px;border-radius:12px;text-decoration:none">Join on mabenn</a>
        <p style="font-size:14px;color:#a1a1aa;margin:8px 0 0">If you didn't expect this invite, you can safely ignore this email.</p>
      </div>
      <hr style="border:none;border-top:1px solid #e4e4e7;margin:32px 0" />
      <p style="font-size:14px;color:#a1a1aa;text-align:center;margin:0">&copy; 2026 mabenn &middot; Shared billing you can trust</p>
    </td></tr>
  </table>
</body>
</html>`
