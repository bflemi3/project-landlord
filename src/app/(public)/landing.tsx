  ...
  return (
    <section className="relative px-6 pt-10 pb-24 md:pt-16 md:pb-32">
      ...
      <div className="relative z-10">
        ...
        <FadeUp delay={0.32}>
          <p className="mt-7 max-w-[34ch] text-[17px] leading-[1.55] text-[#a8a29e] md:text-[18px]">
            {props.subtitle}
          </p>
        </FadeUp>
        <FadeUp delay={0.44}>
  ...
  return (
    <section id="waitlist" className="relative px-6 py-24 md:py-32">
      ...
      <div className="relative z-10 text-center">
        ...
        <FadeUp delay={0.18}>
          <p className="mx-auto mt-5 max-w-[34ch] text-[16px] leading-[1.55] text-[#a8a29e]">
            {subtitle}
          </p>
        </FadeUp>
        <FadeUp delay={0.3}>
          <div className="mx-auto mt-10 max-w-md">
            <WaitlistForm />
            <p className="mt-5 text-[12.5px] leading-[1.5] text-[#78716c]">{finePrint}</p>
          </div>
        </FadeUp>
      </div>
    </section>
...
function FinalCtaGlow() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      <div
        className="absolute -left-32 top-1/2 h-[400px] w-[600px] -translate-y-1/2 rounded-full opacity-50 blur-[100px]"
        style={{
          background:
            'radial-gradient(ellipse at 30% 50%, rgba(233,64,143,0.28) 0%, rgba(233,64,143,0) 70%)',
        }}
      />
    </div>
  )
...
function Pillar1() {
  const t = useTranslations('landing')
  return (
    <section id="pillar-1" className="relative py-24 md:py-32">
    ...
    <div className="relative mt-16">
      ...
      >
        ...
        <div
          ...
          aria-hidden
        />
        <div className="absolute top-12 left-10 right-10 overflow-hidden rounded-[18px] border border-white/[0.10] bg-[#1a1a19] shadow-[0_30px_60px_-20px_rgba(0,0,0,0.5)]">
          ...
          />
          <RevenueChartSVG nowLabel={t('revNowLabel')} projectedLabel={t('revProjectedLabel')} />
...
function RevenueChartSVG({ nowLabel, projectedLabel }: { nowLabel: string; projectedLabel: string }) {
  ...
  return (
    <div className="px-2 pt-4 pb-2">
      ...
      >
        ...
        <circle cx={nowX} cy={nowY} r="7" fill="#e9408f" fillOpacity="0.18" />
...
function Comparison() {
  ...
  const rows = [
    ...
    { label: t('compRow6Label'), pm: t('compRow6PM'), mabenn: t('compRow6Mabenn') },
  ]
  return (
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <FadeUp delay={0.4}>
          <p className="mx-auto mt-16 max-w-3xl text-center font-display text-[22px] font-medium leading-[1.45] tracking-[-0.005em] text-[#f5f5f4] md:text-[26px]">
            {t('compCloserPart1')}{' '}
            <span className="text-[#e9408f]">{t('compCloserFigure')}</span>{' '}
            {t('compCloserPart2')}
          </p>
        </FadeUp>
      </div>
