...
import { useUnitTenants, useUnitInvites, type UnitTenant, type UnitInvite } from '@/data/units/client'
...
import { resendInvite } from '@/data/properties/actions/resend-invite'
import { cancelInvite } from '@/data/properties/actions/cancel-invite'
import { removeTenant } from '@/data/properties/actions/remove-tenant'
...
function InviteRow({ invite, onSelect }: { invite: UnitInvite; onSelect: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-sm font-medium text-foreground">{invite.name ?? invite.email}</p>
        {invite.name && (
