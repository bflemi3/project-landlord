...
const SECTION_ID: SectionId = 'cpf'
    ...
    >
      <Section.Header ref={registerHeaderRef(SECTION_ID)}>
        ...
        <Section.HeaderContent>
          <Section.Title>{t('cpf.title')}</Section.Title>
          <Section.Subtitle>{t('cpf.subtitle')}</Section.Subtitle>
        </Section.HeaderContent>
        <Section.Status
      ...
      <Section.Body>
        <p className="text-muted-foreground">{t('cpf.placeholder')}</p>
        <Section.Actions
...
export function CpfSectionSkeleton() {
