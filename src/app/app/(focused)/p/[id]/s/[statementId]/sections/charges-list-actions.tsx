...
import { useStatementSheet } from '../statement-sheet-context'
...
export function ChargesListInteractive({
  ...
  const { onAddCharge, onAddMissingCharge, onEditCharge } = useStatementSheet()
            ...
            {missingCharges.map((missing) => {
              ...
              return (
                <ChargeRow
                  ...
                  onClick={() => onAddMissingCharge(missing)}
                >
                  <ChargeRowIcon>
